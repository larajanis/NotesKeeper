  ...
  <body>
    ...
    <div class="container">
        ...
        <form:form method="POST" modelAttribute="userForm" class="form-signin">
            ...
            <spring:bind path="role_code">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="role_code" class="form-control" placeholder="Role"></form:input>
                    <form:errors path="role_code"></form:errors>
                </div>
            </spring:bind>
            ...
            <spring:bind path="year">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="year" class="form-control" placeholder="Year"></form:input>
            ...
            <spring:bind path="semester">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="semester" class="form-control" placeholder="Semester"></form:input>
